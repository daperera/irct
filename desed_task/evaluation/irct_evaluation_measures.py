...
def compute_per_intersection_macro_f1(
    ...
    for threshold in prediction_dfs.keys():
        if not prediction_dfs[threshold].empty:
            threshold_f1, classwise_score_f1 = psds.compute_macro_f_score(prediction_dfs[threshold])
        else:
            threshold_f1 = 0
    ...
    return psds_macro_f1 if average=="macro" else (psds_macro_f1, classwise_score_f1)

def compute_per_intersection_macro_f1_from_df(
    prediction_dfs,
    gt,
    durations,
    dtc_threshold=0.5,
